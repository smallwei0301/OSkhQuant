...
> **2025 年更新**：新增 `web-app/` 目錄，內含「Lazybacktest 雲端回測中心」前端專案，可直接部署至 Netlify。最新版本（LBK-NETLIFY-V3）已串接台灣證券交易所 OpenAPI，提供上市公司清單即時更新、CSV 匯入、雙均線 + RSI 回測與權益曲線視覺化等功能，滿足高流量網站對即時互動的需求。
