...
> **2025 年更新**：新增 `web-app/` 目錄，內含「Lazybacktest 雲端回測中心」前端專案，可直接部署至 Netlify，提供瀏覽器版的 CSV 匯入、雙均線 + RSI 回測與權益曲線視覺化功能，並整合台灣證券交易所 Open API 以即時取得上市公司名錄與日線行情，滿足高流量網站對即時互動的需求。
